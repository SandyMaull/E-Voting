...
@section('body')
    ...
    @if (isset($dpm))
        @foreach ($tim_dpm as $dpm)
            ...
            @if (count($kandidat->where('tim_id', $dpm->id)) != 0)
                <h1 class="h1-awal">{{$voting->judul}}</h1>
                <main id="tim_bem">
                    @foreach ($kandidat->where('tim_id', $dpm->id) as $kand)
                        <div class="card">
                            <div class="card-header">
                                <blockquote class="blockquote text-center">
                                    <p class="mb-0">{{ $kand->nama }}</p>
                                    <footer class="blockquote-footer">{{ $kand->identitas }}</footer>
                                </blockquote>
                            </div>
                            <div class="card-body">
                                <main id="bem_bagian">
                                            ...
                                            <div class="row">
                                                <div class="col col-sm-12">   
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li><small>{{ $kand->identitas }}</small></li>
                                ...
                                <button type="button" class="btn btn-primary" data-toggle="modal" 
                                    data-target="#modal_details" data-namatim="{{ $kand->nama }}" data-nama="{{ $kand->nama }}" data-nim="{{ $kand->identitas }}" 
                                    data-visi="{{ $kand->visi }}" data-misi="{{ $kand->misi }}" data-pengalaman="{{ $kand->pengalaman }}" 
                                    data-image="{{ asset('image/'.$kand->image) }}">
                                        Detail
                                </button>
